...
func (t *TestRepo) GetTransactionForAccount(accountUUID uuid.UUID, pagination models.PaginationInput) ([]models.Transaction, error) {
...
func (t *TestRepo) GetAccountsForUser(userUUID uuid.UUID, paganition models.PaginationInput) ([]models.Account, error) {
